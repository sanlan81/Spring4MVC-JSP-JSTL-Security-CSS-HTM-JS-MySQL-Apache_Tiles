...
public class UpdateJspServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (req.getParameter("title") == null && req.getParameter("composer") == null && req.getParameter("yearIssue") == null && req.getParameter("description") == null && Integer.valueOf(req.getParameter("numberOfPages")) == null) {
